...
/////////////////////////////////////////////////////////////////
//   Adapted by Francois Laupretre <francois@tekwire.net>      //
//   for PHK packaging examples                                //
/////////////////////////////////////////////////////////////////
//                                                             //
...
define('MP3_FILE','./demo.mp3');

// include getID3() library package
...
$ThisFileInfo = $getID3->analyze(MP3_FILE);
...
echo "File: ".MP3_FILE."\n";
foreach($ThisFileInfo['comments_html'] as $key => $v)
	{
	echo ucfirst($key).': '.$v[0]."\n";
	}
